    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('book/contact_us'); ?>">
                        <i class="fas fa-fw fa-comments"></i>
                        <span>Contact Us</span></a>
                </li>
                ...
                <div id="content">
                        ...
                        <div class="topbar-divider d-none d-sm-block"></div>
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                    ...
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">Hi, Book</span>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                    <form method="get" action="<?php echo base_url('book/list_receipt') ?>">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2" style="margin-top: 10px;">
                                                <a href="<?php echo base_url('book'); ?>" class="form-control btn btn-warning"><i class="fa fa-redo"></i> Reset</a>
                                            </div>
                                        </div>
                                    </form>
                                    <hr>
                                        <div class="row" style="margin-top: 10px;">
                                            <div class="col-md-2" style="margin-top: 10px;">
                                                <a href="<?php echo base_url('book/view_all'); ?>" class="form-control btn btn-info">All Data</a>
                                            </div>
                                            <div class="col-md-3" style="margin-top: 10px;">
                                                <form action="" method="post">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control float-right" placeholder="Cari Data..." name="keyword">
        ...
        <div class="modal fade" id="contact_us">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <!-- Modal body -->
                    <div class="modal-body">
                        <form method="post" action="<?php echo base_url('book/contact') ?>">
                            <div class="form-group">
