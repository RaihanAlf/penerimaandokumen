    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- <li class="nav-item">
                    <a class="nav-link" href="<?= site_url('master/feedback')?>">
                                            ...
                                            <tr>
                                                ...
                                                <td width="250">
                                                    <div class="action">
                                                        ...
                                                        &nbsp;
                                                        <a href="#" 
                                                            data-delete-url="<?= site_url('master/dashboard/delete/'.$dt['id']) ?>" 
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="<?php echo base_url('master/dashboard/edit_dokumen') ?>">
